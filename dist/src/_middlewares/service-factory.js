...
exports.deleteOneAndMany = exports.updateOne = exports.getOneBySlug = exports.getOne = exports.createOne = exports.getAll = void 0;
...
const getAll = (Model) => (0, catch_async_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { count, rows } = yield Model.findAndCountAll(Object.assign({ limit: pageSize, offset: (page - 1) * pageSize, include: Model.name === 'users' ? include : updateInclude(include), attributes: Model.name === 'users' ? attributes : updatedAttributes(attributes) }, opts));
...
const getOne = (Model) => (0, catch_async_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const doc = yield Model.findByPk(id, Object.assign({ include: Model.name === 'users' ? include : updateInclude(include), attributes: Model.name === 'users' ? attributes : updatedAttributes(attributes) }, opts));
    if (!doc) {
...
const getOneBySlug = (Model) => (0, catch_async_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const doc = yield Model.findOne(Object.assign({ where: Object.assign({ slug: slug }, where), include: Model.name === 'users' ? include : updateInclude(include), attributes: Model.name === 'users' ? attributes : updatedAttributes(attributes) }, opts));
    if (!doc) {
...
const deleteOneAndMany = (Model) => (0, catch_async_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    if (Number.isNaN(+id)) {
